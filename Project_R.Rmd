...
# Change all null values and empty string in the country column to Global.
music_data$country[music_data$country == ""] <- "Global"
...
```{r}
Music_Final <- read.csv("Music_Final.csv")
```
